...
pub fn create_config() -> Result<(), ParseError>{
    ...
    */
    ...
    let config = Config{port: _port.parse::<i32>().unwrap(),url: path_url.clone()};
    
    println!("[port: {},bytes_read: {}]",_port,port_byte_size);
